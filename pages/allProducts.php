    ...
    ?>
            <div class="col-md-4 mt-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h3 class="card-card-title"><?php echo $product['name'] ?></h3>
                        <p class="">Product Price : BDT <?php echo $product['price'] ?></p>
                        <p class="text-justify"><?php echo $product['description'] ?></p>
                        <a href="action.php?pages=product-details&&product_id=<?php echo $product['id']; ?>"
                            class="btn btn-outline-warning float-right">View</a>
                    </div>
                </div>
            </div>
            <?php }?>
